...
import { createStudentPost } from "../../actions";
  ...
  return (
    <>
      <div className="portal-topbar">
        <a href="/student/chat/post" style={{ color: "#fff", display: "inline-flex", alignItems: "center", gap: 6, textDecoration: "none", fontSize: 14 }}>
      ...
      <div className="portal-content">
        <form action={createStudentPost} className="card" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
