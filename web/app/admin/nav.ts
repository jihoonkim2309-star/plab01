...
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      { label: "지점 관리", slug: "centers", href: "/admin/centers", icon: "Building2", ready: true, reviewed: true },
  ...
  },
  {
    label: "회원",
    items: [
      { label: "회원 목록/상세", slug: "members", href: "/admin/students", icon: "Users", ready: true, reviewed: true },
  ...
  },
  {
    label: "수업 운영",
    items: [
      { label: "클래스 관리", slug: "class-manage", href: "/admin/classes", icon: "BookOpen", ready: true },
      { label: "클래스 생성", slug: "class-create", href: "/admin/classes/new", sub: true, ready: true },
      { label: "월간 시간표", slug: "schedule", href: "/admin/schedule", icon: "CalendarDays", ready: true },
  ...
  },
  {
    label: "결제",
    items: [
      { label: "수강 상품 관리", slug: "product-manage", href: "/admin/products", icon: "Wallet", ready: true, reviewed: true },
  ...
  },
  {
    label: "리포트",
    items: [
      { label: "리포트 관리", slug: "report-list", href: "/admin/reports", icon: "FileText", ready: true, reviewed: true },
  ...
  },
  {
    label: "셔틀",
    items: [
      { label: "셔틀 현황", slug: "shuttle", href: p("shuttle"), icon: "Bus" },
  ...
  },
  {
    label: "상담",
    items: [
      { label: "문의/채팅", slug: "support", href: "/admin/support", icon: "MessageSquare", ready: true, reviewed: true },
  ...
  },
  {
    label: "시스템",
    items: [
      { label: "알림/로그", slug: "logs", href: "/admin/notifications", icon: "Bell", ready: true, reviewed: true },
      ...
      { label: "설정", slug: "settings", href: "/admin/settings", icon: "Settings", ready: true, reviewed: true },
    ],
  },
];
