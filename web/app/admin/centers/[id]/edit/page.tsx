      ...
      <form action={updateCenter} className="panel elevated">
        ...
        <div className="panel-body">
          <div className="form-grid">
            ...
            <PolicyFields
              defaults={{
                plan: center.subscription_plan ?? "정액",
                base_fee: center.subscription_base_fee ?? 0,
                per_student: center.subscription_per_student ?? 0,
                revenue_pct: center.subscription_revenue_pct ?? 0,
                hq_billing_day: center.hq_billing_day ?? 1,
              }}
            />
          </div>
