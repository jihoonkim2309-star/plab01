...
const MOCK: Notice = {
  id: "mock",
  title: "본사 시스템 점검 안내",
  body: "안녕하세요 학부모님,\n\n6월 8일(일) 02:00 ~ 04:00 본사 시스템 정기 점검이 진행됩니다.\n해당 시간에는 앱·웹 일부 기능이 일시 중단될 수 있으니 양해 부탁드립니다.\n\n감사합니다.",
  published_at: "2026-06-04T10:00:00",
};
...
export default async function ParentNoticeDetail({
  params,
}: {
  ...
  return (
    <>
      <div className="portal-topbar">
        <a href="/parent/notices" style={{ color: "#fff", display: "inline-flex", alignItems: "center", gap: 6, textDecoration: "none", fontSize: 14 }}>
