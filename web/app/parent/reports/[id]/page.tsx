...
async function fetchDetail(id: string): Promise<Report | null> {
  ...
  // 열람 기록 RPC (멱등, 본인 자녀만)
  await supabase.rpc("record_report_view", { p_report_id: id });
  ...
  return (
    <>
      <div className="portal-topbar">
        <a href="/parent/reports" style={{ color: "#fff", display: "inline-flex", alignItems: "center", gap: 6, textDecoration: "none", fontSize: 14 }}>
