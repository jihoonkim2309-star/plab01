...
const MOCK_EVENTS = [
  { date: "2026-06-08", type: "class" as const, className: "정규반 A", classId: "m1", time: "16:00 - 17:00", coach: "박코치", color: "green", isMine: true, studentName: "박도윤" },
];
...
async function fetchData(tab: Tab) {
  ...
  if (guard.isEmbed) {
    ...
    return { events: MOCK_EVENTS, from, to };
  }
    ...
    <>
      ...
      <div className="portal-content">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6, marginBottom: 12 }}>
          {([{ v: "mine" as Tab, label: "내 자녀" }, { v: "center" as Tab, label: "학원 전체" }]).map((t) => {
            const on = t.v === tab;
            return (
              <a
                key={t.v}
